...
export default function PuzzlePage() {
  ...
  // find out which “Day” we’re on for the header
  const dayNumber = !isNaN(previewDay)
    ? previewDay
    : tomorrowMode
      ? ((new Date().getDay()+6)%7) + 2 // today’s index+1
      : ((new Date().getDay()+6)%7) + 1 // today’s index
  // clamp 1–7
  const displayDay = ((dayNumber-1)%7)+1
