...
export default function PuzzlePage() {
  ...
  // — if done and not memory day, show results —
    ...
    return (
      <>
        ...
        <main style={{textAlign:'center',padding:'2rem'}}>
          <h1>🎉 You’ve completed Day {displayDay}!</h1>
          <p style={{fontSize:'1.2rem'}}>You scored <strong>{score}/{puzzles.length}</strong></p>
          {passed && isNaN(previewDay) && !tomorrowMode ? (
            <>
              <p style={{color:'green'}}>Unlocked tomorrow’s challenge!</p>
              <Link href="/puzzle/1?tomorrow=1"><button style={{margin:'0.5rem',padding:'8px 16px'}}>Start Tomorrow’s</button></Link>
            </>
          ) : !passed ? (
            <p style={{color:'red'}}>Need 8/10 to unlock tomorrow. Try again tomorrow!</p>
          ) : null}
      ...
      return (
        <div className="quiz-page">
          ...
          <div className="main" style={{textAlign:'center',padding:'2rem'}}>
            ...
            <p style={{marginBottom:'1rem'}}>What was the 3rd number you saw?</p>
  ...
  return (
    <div className="quiz-page">
      ...
      <div className="adL" style={{background:'#eee'}}>Ad Left</div>
      <div className="main" style={{textAlign:'center',padding:'2rem'}}>
        <Head><title>Day {displayDay} – Puzzle {idNum}</title></Head>
